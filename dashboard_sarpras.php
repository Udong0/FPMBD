...
<div class="list-group">
    <a href="manajemen_peminjaman_sarpras.php" class="list-group-item list-group-item-action">Persetujuan Peminjaman Ruangan</a>
    <a href="#" class="list-group-item list-group-item-action">Jadwal Penggunaan Ruangan</a>
    <a href="#" class="list-group-item list-group-item-action">Manajemen Daftar Ruangan</a>
</div>
